...
create_clock -name I2S_BCLK_OUTPUT -period 76.923 -waveform {0 38.462} [get_nets {IIS_BCLK_O_d}]
...
set_false_path -from [get_clocks {I2S_FCLK USB_PCLK USB_FCLK I2S_BCLK_OUTPUT}] -to [get_clocks {I2S_FCLK USB_PCLK USB_FCLK I2S_BCLK_OUTPUT}] 
