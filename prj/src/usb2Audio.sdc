...
create_clock -name IIS_BCLK_INPUT_D -period 122.07 -waveform {0 61.035} [get_nets {IIS_BCLK_I_d}]
...
set_false_path -from [get_clocks {USB_PCLK}] -to [get_clocks {IIS_BCLK_INPUT}] 
set_false_path -from [get_clocks {USB_PCLK}] -to [get_clocks {IIS_BCLK_INPUT_D}] 
set_false_path -from [get_clocks {I2S_FCLK}] -to [get_clocks {USB_PCLK}] 
set_false_path -from [get_clocks {USB_PCLK}] -to [get_clocks {I2S_FCLK}] 
set_false_path -from [get_clocks {USB_PCLK}] -to [get_clocks {USB_FCLK}] 
set_false_path -from [get_clocks {IIS_BCLK_INPUT}] -to [get_clocks {I2S_FCLK}] 
set_false_path -from [get_clocks {IIS_BCLK_INPUT_D}] -to [get_clocks {I2S_FCLK}] 